#ifndef SSE2RVV_DEBUG_TOOLS_H
#define SSE2RVV_DEBUG_TOOLS_H
...
template <typename T> void print_u8_64(const char *var_name, T a) {
...
template <typename T> void print_s8_64(const char *var_name, T a) {
...
template <typename T> void print_u16_64(const char *var_name, T a) {
...
template <typename T> void print_s16_64(const char *var_name, T a) {
...
template <typename T> void print_u32_64(const char *var_name, T a) {
...
template <typename T> void print_s32_64(const char *var_name, T a) {
...
template <typename T> void print_u64_64(const char *var_name, T a) {
...
template <typename T> void print_s64_64(const char *var_name, T a) {
...
template <typename T> void print_f32_64(const char *var_name, T a) {
...
template <typename T> void print_u8_128(const char *var_name, T a) {
  const uint8_t *u = (const uint8_t *)&a;
...
template <typename T> void print_s8_128(const char *var_name, T a) {
...
template <typename T> void print_u16_128(const char *var_name, T a) {
  const uint16_t *u = (const uint16_t *)&a;
...
template <typename T> void print_s16_128(const char *var_name, T a) {
...
template <typename T> void print_u32_128(const char *var_name, T a) {
  const uint32_t *u = (const uint32_t *)&a;
...
template <typename T> void print_s32_128(const char *var_name, T a) {
...
template <typename T> void print_u64_128(const char *var_name, T a) {
  const uint64_t *u = (const uint64_t *)&a;
...
template <typename T> void print_s64_128(const char *var_name, T a) {
...
template <typename T> void print_f32_128(const char *var_name, T a) {
  const float *f = (const float *)&a;
